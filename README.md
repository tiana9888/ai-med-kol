...
For tools that do not have a native skill system, you can still use this repository as a prompt/reference pack by attaching or importing `SKILL.md` plus the relevant files in `references/` and `templates/`.
